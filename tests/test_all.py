...
def test_get_previous_downloads(customer_instance):
    customer_instance.existing_paths = ['gs://oeem-***REMOVED***-data/test/consumption/raw/CF-00001634_7719220489_0.xml', 'gs://oeem-***REMOVED***-data/test/consumption/raw/CF-00002637_6439720561_0.xml', 'gs://oeem-***REMOVED***-data/test/consumption/raw/CF-00003605_7992020631_0.xml', 'gs://oeem-***REMOVED***-data/test/consumption/raw/CF-00003879_2893720542_0.xml', 'gs://oeem-***REMOVED***-data/test/consumption/raw/CF-00007103_6296120289_0.xml', 'gs://oeem-***REMOVED***-data/test/consumption/raw/CF-00007335_7248920443_0.xml', 'gs://oeem-***REMOVED***-data/test/consumption/raw/CF-00017364_1065420796_0.xml', 'gs://oeem-***REMOVED***-data/test/consumption/raw/CF-00018429_0307420309_0.xml']
    customer_instance.project_id = 'CF-00001634'
    customer_instance.usage_point_id = '7719220489'
    output = ['gs://oeem-***REMOVED***-data/test/consumption/raw/CF-00001634_7719220489_0.xml']
    assert list(customer_instance._get_previous_downloads()) == output


def test_get_last_run_num(customer_instance):
    paths = ['gs://oeem-***REMOVED***-data/test/consumption/raw/CF-00001634_7719220489_10.xml', 'gs://oeem-***REMOVED***-data/test/consumption/raw/CF-00001634_7719220489_0.xml', 'gs://oeem-***REMOVED***-data/test/consumption/raw/CF-00001634_7719220489_8.xml']
    output = 10
